/**
 * Query analysis: infers *what* the user is looking for (media type, title,
 * artist/album, year, quality, resolution, codec, language, season/episode)
 * instead of treating every query as a bare torrent search.
 *
